...
class Match(db.Model):
    ...
    player1_id = db.Column(db.Integer, db.ForeignKey('user.userid'))
    player2_id = db.Column(db.Integer, db.ForeignKey('user.userid'))
    winner_id = db.Column(db.Integer, db.ForeignKey('user.userid'))
...
class Order(db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey(
        'user.userid'), nullable=True)  # Nullable for guest orders
